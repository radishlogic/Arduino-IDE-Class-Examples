 ...
 */
 ...
 // This code will NOT compile because the class definition and variable declaration using the class was made after the loop function.
 // The loop function needs the variable that uses the class to access the check function.
